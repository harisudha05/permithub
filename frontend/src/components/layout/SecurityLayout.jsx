...
const links = {
  ...
  Security: [
    ...
    { to: '/security/history', label: 'Scan History', icon: ClipboardList },
    { to: '/security/late-entries', label: 'Late Entries', icon: Calendar },
...
export default function SecurityLayout({ role }) {
  const roleLinks = links['Security'] || links.Generic
